const y = "data-astro-transition-persist",
  ee = ["data-astro-transition", "data-astro-transition-fallback"],
  M = new Set();
function U(e) {
...
function ne(e) {
  const t = document.documentElement,
    n = [...t.attributes].filter(
      ({ name: o }) => (t.removeAttribute(o), ee.includes(o))
    );
...
const ie = () => {
    ...
    if (e?.closest(`[${y}]`)) {
      if (e instanceof HTMLInputElement || e instanceof HTMLTextAreaElement) {
        const t = e.selectionStart,
          n = e.selectionEnd;
        return () => k({ activeElement: e, start: t, end: n });
      }
      return () => k({ activeElement: e });
    } else return () => k({ activeElement: null });
  },
  ...
  ce = (e, t) => e.getAttribute("props") === t.getAttribute("props"),
  le = (e) => {
    te(e), ne(e), oe(e);
    const t = ie();
    re(e.body, document.body), t();
  },
  ue = "astro:before-preparation",
...
class pe extends q {
  ...
  loader;
  constructor(t, n, o, r, i, u, a, c, f, l) {
    super(ue, { cancelable: !0 }, t, n, o, r, i, u, a, c),
      (this.formData = f),
...
async function ge(e, t, n, o, r, i, u, a, c) {
  const f = new pe(e, t, n, o, r, i, window.document, u, a, c);
  return (
    document.dispatchEvent(f) &&
      (await f.loader(),
      f.defaultPrevented ||
        (he(fe), f.navigationType !== "traverse" && x({ scrollX, scrollY }))),
    f
  );
}
...
const G = (e, t, n, o, r) => {
  ...
  if (e.href !== location.href && !r)
    ...
    } else be({ ...n.state, index: ++v, scrollX: 0, scrollY: 0 }, "", e.href);
  if (
    ((document.title = u),
    (R = e),
    ...
    if (e.hash) {
      ...
      (location.href = e.href),
        history.state ||
          (E(c, ""), i && window.dispatchEvent(new PopStateEvent("popstate")));
...
async function _(e, t, n, o, r) {
  async function i(f) {
    ...
    document.documentElement.setAttribute(P, f);
    const b = document.getAnimations().filter((d) => !s.includes(d) && !l(d));
  ...
  const u = async () => {
    ...
    a = document.title,
    c = await ye(e, n.viewTransition, u);
  G(c.to, c.from, t, a, o),
    V(me),
    r === "animate" &&
...
async function z(e, t, n, o, r) {
  ...
  if (
    ...
    G(n, t, o, document.title, r), i === m && (m = void 0);
    return;
  }
  const a = await ge(
    t,
  ...
  async function c(s) {
    ...
    if (
      ((C ??= new DOMParser()),
      (s.newDocument = C.parseFromString(d.html, d.mediaType)),
  ...
  if ((document.documentElement.setAttribute(F, a.direction), I))
    l.viewTransition = document.startViewTransition(
      async () => await _(a, o, l, r)
    );
  else {
    const s = (async () => {
      await Promise.resolve(), await _(a, o, l, r, K());
    })();
    l.viewTransition = {
...
async function X(e, t) {
  await z("forward", R, new URL(e, location.href), t ?? {});
}
function Re(e) {
  if (!N() && e.state) {
    location.reload();
  ...
  const t = history.state,
    n = t.index,
    o = n > v ? "forward" : "back";
  (v = n), z(o, R, new URL(location.href), {}, t);
}
const Y = () => {
  history.state &&
...
function De() {
  ...
  O(() => {
    for (const t of document.getElementsByTagName("a"))
      S.has(t) || (T(t, "viewport") && (S.add(t), (e ??= xe()), e.observe(t)));
  });
}
function xe() {
  const e = new WeakMap();
...
(I || Oe() !== "none") &&
  ...
  document.addEventListener("submit", (e) => {
    ...
    const n = e.submitter,
      o = n && n === A;
    if (((A = null), t.tagName !== "FORM" || e.defaultPrevented || $(t) || o))
      return;
    const r = t,
      i = new FormData(r, n),
    ...
    const f = n?.getAttribute("formmethod") ?? a ?? "get";
    if (f === "dialog" || location.origin !== new URL(c, location.href).origin)
      return;
